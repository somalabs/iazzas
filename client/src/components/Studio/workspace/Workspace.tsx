...
export default function Workspace() {
  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto">
      <div className="flex-1 space-y-4 px-4 pb-0 pt-[68px]">
        ...
        {activeSchema && (
          <div className="space-y-0.5">
            <h2 className="text-lg font-semibold text-text-primary">{activeSchema.displayName}</h2>
        ...
        {activeSchema?.compliance?.requiresHumanReview && (
          <div className="flex items-start gap-2 rounded-lg border border-border-medium bg-surface-secondary px-3 py-2 text-xs text-text-secondary">
            <TriangleAlert
              className="mt-0.5 h-3.5 w-3.5 flex-shrink-0 text-text-warning"
              strokeWidth={1.5}
            />
      ...
      <div className="bg-surface-primary/95 sticky bottom-0 border-t border-border-medium px-4 py-3 backdrop-blur-sm">
