...
> = {
  running: {
    ...
    labelKey: 'com_studio_flow_run_status_running',
  },
  paused: {
    icon: Pause,
    colorClass: 'text-orange-400',
    labelKey: 'com_studio_flow_run_status_paused',
  },
  success: {
    icon: CheckCircle,
    colorClass: 'text-emerald-400',
    labelKey: 'com_studio_flow_run_status_success',
  },
  failed: {
    icon: XCircle,
    colorClass: 'text-red-400',
    labelKey: 'com_studio_flow_run_status_failed',
  },
  skipped: {
    icon: SkipForward,
    colorClass: 'text-text-tertiary',
    labelKey: 'com_studio_flow_run_status_skipped',
  },
};
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-border-light bg-surface-primary">
      ...
      >
        ...
        <span className={cn('flex-shrink-0 text-[10px] font-medium', config.colorClass)}>
