...
> = {
  pending: {
    ...
    labelKey: 'com_studio_flow_node_run_pending',
  },
  running: {
    icon: Loader,
    colorClass: 'text-blue-400',
    labelKey: 'com_studio_flow_node_run_running',
    spin: true,
  },
  completed: {
    icon: CheckCircle,
    colorClass: 'text-emerald-400',
    labelKey: 'com_studio_flow_node_run_completed',
  },
  skipped: {
    icon: SkipForward,
    colorClass: 'text-text-tertiary',
    labelKey: 'com_studio_flow_node_run_skipped',
  },
  failed: {
    icon: XCircle,
    colorClass: 'text-red-400',
    labelKey: 'com_studio_flow_node_run_failed',
  },
  waiting: {
    icon: Pause,
    colorClass: 'text-orange-400',
    labelKey: 'com_studio_flow_node_run_waiting',
  },
};
    ...
    <div className="flex items-start gap-2 py-1.5">
      ...
      <div className="min-w-0 flex-1">
        ...
        >
          ...
          <span className={cn('text-[10px]', config.colorClass)}>{localize(config.labelKey)}</span>
        </button>
