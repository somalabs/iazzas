        ...
        <div className={'relative w-full'}>
          <Trigger asChild>
            <button
              ...
              className={cn(
                'pointer-cursor relative flex flex-col rounded-lg border border-black/10 bg-paper py-2 pl-3 pr-10 text-left focus:ring-0 focus:ring-offset-0 dark:border-gray-700 dark:bg-gray-800 sm:text-sm',
          ...
          <Portal>
            <Content
              ...
              align="start"
              className={cn(
                'z-50 mr-3 mt-2 max-h-[52vh] w-full max-w-[85vw] overflow-hidden overflow-y-auto rounded-lg border border-gray-200 bg-paper shadow-lg dark:border-gray-700 dark:bg-gray-700 dark:text-white sm:max-w-full lg:max-h-[52vh]',
