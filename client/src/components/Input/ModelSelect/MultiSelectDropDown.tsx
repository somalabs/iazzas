        ...
        <Listbox value={value} onChange={handleSelect} disabled={disabled}>
          {() => (
            <>
              <ListboxButton
                className={cn(
                  'relative flex w-full cursor-default flex-col rounded-md border border-black/10 bg-paper py-2 pl-3 pr-10 text-left focus:outline-none focus:ring-0 focus:ring-offset-0 dark:border-gray-600 dark:border-white/20 dark:bg-gray-800 sm:text-sm',
                  className ?? '',
                )}
                id={excludeIds[0]}
                        ...
                        {value.map((v, i) => (
                          ...
                          >
                            {v.icon ? (
                              ...
                              <Wrench className="h-full w-full rounded-sm bg-paper" />
                            )}
              ...
              >
                <ListboxOptions
                  ref={menuRef}
                  className={cn(
                    'absolute z-50 mt-2 max-h-60 w-full overflow-auto rounded bg-paper text-base text-xs ring-1 ring-black/10 focus:outline-none dark:bg-gray-800 dark:ring-white/20 dark:last:border-0 md:w-[100%]',
                    optionsClassName,
                  )}
                >
                  {searchRender}
